...
var ComplimentRepository_1 = require("../repositories/ComplimentRepository");
...
var CreateComplimentService = /** @class */ (function () {
    ...
    CreateComplimentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var complimentRepository, userRepository, userReceiverExists, compliment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        complimentRepository = typeorm_1.getCustomRepository(ComplimentRepository_1.ComplimentRepository);
                    ...
                    case 1:
                        ...
                        compliment = complimentRepository.create({
                            tag_id: tag_id,
                            user_receiver: user_receiver,
                            user_sender: user_sender,
                            message: message
                        });
                        return [4 /*yield*/, complimentRepository.save(compliment)];
                    case 2:
                        _b.sent();
